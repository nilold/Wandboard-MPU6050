...
private:
	...
	double getTime();
	void Receive(uint8_t, uint8_t* data);	//Get a single char data from MPU (register address, data pointer)
	void Transmit(int, uint8_t);			//Transmit a single char to MPU	(register address, data)
	void connectionTest();

public:
	MPU(const char*);
	// void init_MPU ();				//Set MPU6050 configurations, such as accel sensitivity
	bool connectI2C(const char* device_name);
	void disconnectI2c(const char*);
...
#ifdef	GYRO250
	#define GYROSEN		0b00000000
	#define gyrosen		131
#endif
#ifdef	GYRO500
	#define GYROSEN		0b00001000
	#define gyrosen		65.5
#endif
#ifdef	GYRO1000
// #define GYROSEN		0b00010000
// #define gyrosen		32.8
#endif
#ifdef	GYRO2000
	#define GYROSEN		0b00011000
	#define gyrosen		16.4
#endif
#ifdef	ACCEL2G
	#define ACCELSEN	0b00000000
#endif
#ifdef	ACCEL4G
	#define ACCELSEN	0b00001000
#endif
#ifdef	ACCEL8G
#define ACCELSEN	0b00010000
#endif
#ifdef	ACCEL16G
	#define ACCELSEN	0b00011000
#endif
